...
class TestLibrary {
    ...
    @Test
    fun testResetPulse() {
        memory.mem.set(0, 0x11)
        memory.mem.set(1, 0x22)
        memory.mem.set(2, 0x33)
        memory.mem.set(3, 0x44)     // stack pointer set
        memory.mem.set(4, 0xaa.toByte())
        memory.mem.set(5, 0xbb.toByte())
        memory.mem.set(6, 0xcc.toByte())
        memory.mem.set(7, 0xdd.toByte())    // program counter set
        Ksim68k.pulseReset()
